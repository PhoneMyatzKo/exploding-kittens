...
import (
	...
	shadowsgame "boardgame/kittens/internal/games/shadows/game"
...
var catalogue = []Info{
	...
	{
		Slug: Shadows, Name: "State of Shadows",
		Tagline: "Everyone has a secret. Someone is collecting them.",
		Emoji:   "\U0001F576\uFE0F",
		Min:     shadowsgame.MinPlayers, Max: shadowsgame.MaxPlayers, Playable: true,
	},
	{
